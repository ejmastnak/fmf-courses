...
\begin{minipage}[t]{0.90\textwidth}
    Description of courses taken by Elijan Mastnak in the scope of the bachelor's degree in \textit{Physics} offered by the Faculty of Mathematics and Physics at the University of Ljubljana,
    prepared for application to the MET masters program at the Barcelona School of Telecommunications Engineering.
    The curriculum shares many similarities to the (probably more familiar) ETSETB bachelors degree in \textit{Engineering Physics}; for orientation, a comparison of the two programs appears in the \hyperref[s:comparison]{Appendix}.

    \vspace{3ex}
    \textbf{Navigating the table of contents}\\[0.5ex]
    The table of contents appears on the next page and is fully hyperlinked for easier document navigation.
    The table of contents contains the following four columns:
    \begin{itemize}
        \item The \textbf{Course} column contains the course name exactly as it appears on my official academic transcript issued by the University of Ljubljana;
    ...
    \vspace{2ex}
    \textbf{About the course descriptions}\\[0.5ex]
    Each course's material is divided by chapter and presented in bullet-point form.
    Two things are worth mentioning:
    \begin{itemize}
    
        \item A link to an official University of Ljubljana description is provided for each course.
        Note, however, that the official descriptions are less thorough than those given in this document and may contain typos or poor English.
        ...
        \item When available, a link to lecture notes and/or solved exercises from the course is provided so that, if desired, one can see the unabridged course contents.
...
\begin{table}[htb!]
    ...
    \hyperref[mathematics-1]{Mathematics I} & Real analysis & 10 & 1\\
    \hyperref[mathematics-2]{Mathematics II} & Linear algebra \& multivariable calculus & 8 & 1\\
    ...
    \hyperref[proseminar-a]{Proseminar A} & Mathematical methods for classical physics & 3 & 1\\
    \hyperref[physics-laboratory-1]{Physics Laboratory I} & & 4 & 1\\
    \hyperref[physics-laboratory-2]{Physics Laboratory II} & & 4 & 1\\
    \hyperref[computing-laboratory]{Computing Laboratory} & Introduction to programming in C & 3 & 1\\
    \hyperref[chemistry-1]{Chemistry I} & Inorganic chemistry & 3 & 1\\
    ...
    \hline
    \hline {\rule{0pt}{2.5ex}} \hspace{-7pt}
    \hyperref[mathematics-3]{Mathematics III} & Vector calculus, LDEs, Hilbert spaces & 8 & 2\\
    \hyperref[mathematics-4]{Mathematics IV} & Complex analysis, Fourier analysis, PDEs & 6 & 2\\
    \hyperref[modern-physics-1]{Modern Physics I} & Special relativity \& quantum mechanics & 8 & 2\\
    \hyperref[modern-physics-2]{Modern Physics II} & Solid state, nuclear, \& particle physics & 5 & 2\\
    \hyperref[classical-mechanics]{Classical Mechanics} & & 5 & 2\\
    \hyperref[statistical-thermodynamics]{Statistical Thermodynamics} & & 5 & 2\\
    \hyperref[physics-laboratory-3]{Physics Laboratory III} & & 4 & 2\\
    \hyperref[physics-laboratory-4]{Physics Laboratory IV} & & 4 & 2\\
    \hyperref[probability-in-physics]{Probability in Physics} & Probability and statistics & 3 & 2\\
    \hyperref[numerical-methods]{Numerical Methods} & & 3 & 2\\
    \hyperref[electronics-1]{Electronics I} & Analog electronics & 3 & 2\\
    \hyperref[electronics-2]{Electronics II} & Digital electronics and control theory & 3 & 2\\
    ...
    \hyperref[physics-laboratory-5]{Physics Laboratory V} & & 7 & 3\\

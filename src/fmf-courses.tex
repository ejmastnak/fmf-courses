...
\begin{minipage}[t]{0.90\textwidth}
    This document, which I have prepared for application to the MET masters program at the Barcelona School of Telecommunications Engineering, 
    describes the courses I (i.e. Elijan Mastnak) took to complete the bachelor's degree in \textit{Physics} offered by the Faculty of Mathematics and Physics (FMF) at the University of Ljubljana.
    ...
    \begin{itemize}
        ...
        \item when available, a link to lecture notes and/or solved exercises from the course so that, if desired, the reader can view the full course material.
...
\begin{itemize}
    ...
    \item FMF lacks the advanced elective courses offered in the 7th semester at ETSETB.

    \item ETSETB's full-semester undergraduate thesis is replaced by FMF's \hyperref[seminar]{Seminar} course.
    The length of the Seminar paper is less than a traditional undergraduate thesis, but the Seminar is still a project of considerable scope.
...
\begin{itemize}
    ...
    \item The ETSETB \textit{Engineering Physics} curriculum is divided into its eight semesters.

    \item Each ETSETB semester's courses appear in italics in a bulleted list.

    \item The FMF course(s) covering the same material as the ETSETB course appear as blue hyperlinks to the course description earlier in this document.
...
\begin{itemize}
    ...
    The ETSETB chapters ``Introduction to Stochastic Processes'' and ``The Poisson Process'' are not covered at FMF; I have self-studied them based on MIT Open CourseWare's 6.041 SC.
...
\begin{itemize}
    ...
    \item \textit{Numerical and Computational Methods 2}\correspondsto Covered in \hyperref[numerical_methods]{Numerical Methods} and \hyperref[mathematical_physics_lab]{Mathematical Physics Lab}, although the ETSETB chapter on ``Approximation Theory'' is covered in less detail in the FMF curriculum.
...
\begin{itemize}
    ...
    I am also familiar with the Hilbert space geometric formulation of signals and systems from Vetterli, Kova\v{c}evi\'{c}, and Goyal's book \textit{Foundations of Signal Processing}.

    The ETSETB chapters ``Stochastic Processes -- Random Signals'', ``Fundamentals of Estimation Theory'', ``Spectral Estimation'', and ``Optimal Wiener Filtering'' are not covered in the FMF curriculum, although I have self-studied the material, to some extent, from MIT Open CourseWare's 6.041 SC and Vetterli, Kova\v{c}evi\'{c}, and Goyal's \textit{Foundations of Signal Processing}.
...
\begin{itemize}
    ...
    \item \textit{Control Theory}\correspondsto The material is mostly covered in \hyperref[electronics_1]{Electronics I} and \hyperref[electronics_2]{II}, but in less detail than at ETSETB.
    \item \textit{Photonics}\correspondsto The contents of ``Part I'' are covered in \hyperref[optics]{Optics}; although ``Part II'' is not formally covered in the FMF curriculum, applications of photonics appear in the experiments in \hyperref[physics_laboratory_2]{Physics Laboratory II}, \hyperref[physics_laboratory_3]{III}, \hyperref[physics_laboratory_4]{IV}, and \hyperref[physics_laboratory_5]{V}.

    \item \textit{Projects of Engineering Physics 2}\correspondsto The projects at ETSETB are not covered in the FMF curriculum, but see the potentially relevant experiments in \hyperref[physics_laboratory_1]{Physics Laboratory I}, \hyperref[physics_laboratory_2]{II}, \hyperref[physics_laboratory_3]{III}, \hyperref[physics_laboratory_4]{IV}, and \hyperref[physics_laboratory_5]{V}.
...
\begin{chapter}{Eighth Semester}
    Seminar in place of undergraduate thesis.
\end{chapter}

...
\begin{minipage}[t]{0.90\textwidth}
    ...
    \vspace{2ex}
    \textbf{\large Contributing}\\[0.5ex]
    The document's \LaTeX{} source code is available under the \href{http://creativecommons.org/licenses/by-nc/4.0/}{CC BY-NC 4.0} license at \href{https://github.com/ejmastnak/fmf-courses}{\texttt{github.com/ejmastnak/fmf-courses}}; pull requests to add additional elective courses are very much welcome.

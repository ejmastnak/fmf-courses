...
\begin{minipage}[t]{0.90\textwidth}
    ...
    % ZA FMF KOLEGE: Če uporabljaš dokument za svoje potrebe,
    % lahko seveda do razumljive mere prilagodiš naslednji odstavek, npr:

    % > This document describes the courses I took while studying in the undergraduate Physics program at the Faculty of Mathematics and Physics (FMF) at the University of Ljubljana.

    % Prosim samo, da ne napišeš, da si ti avtor tega dokumenta.
    ...
    The core curriculum is covered in its entirety, but coverage of elective courses is currently limited to those taken by the author, Elijan Mastnak.
    
    \vspace{2ex}
    Each course is divided into modules, with material summarized in bullet-point form.
    The following information appears at the start of each course description:
    \begin{itemize}
    
        \item A link to an online, official University of Ljubljana description of each course
        (note that the official descriptions may be less complete than those given in this document and may contain occasional typos or imperfect English);

        \item the ETCS awarded for completing the course.

    \end{itemize}

    % ZA FMF KOLEGE: Če uporabljaš dokument za svoje potrebe, lahko zbrišeš naslednji odstavek.
    \vspace{2ex}
    \textbf{\large Personal use and contributing}\\[0.5ex]
    The document's \LaTeX{} source code is available under the \href{http://creativecommons.org/licenses/by-nc/4.0/}{CC BY-NC 4.0} license at \href{https://github.com/ejmastnak/fmf-courses}{\texttt{github.com/ejmastnak/fmf-courses}}; feel free to clone and modify it for your own needs under the terms of the license. 
    Pull requests to add additional elective courses are particularly welcome.

\end{minipage}

\vfill

% ZA FMF KOLEGE: Tudi naslednji odstavek lahko komot prilagodiš/zbrišeš, ampak prosim bodi pošten(a).
% Vesel bi bil, če pustiš (lahko tudi skromen) zabeležek glede vira tega dokumenta, npr:
 
% > \rule{0.45\linewidth}{0.4pt}\\
% > This document builds on the curriculum description at\\
% > \href{https://github.com/ejmastnak/fmf-courses}{\texttt{github.com/ejmastnak/fmf-courses}}.
...
\textit{Fully hyperlinked for easier document navigation---jump to a course by clicking its blue link or page number.}
...
\begin{course}{Probability in Physics}{https://www.fmf.uni-lj.si/en/study-physics/programmes/1fiz/2020/7000777/courses/1177/}{3}
    ...
    \begin{chapter}{Fundamentals of frequentist probability}
        \begin{itemize}
            ...
            \item Foundational concepts: random experiments, outcomes, sample space, and events;
            formulation of events as sets.

            \item Axioms of probability; certain, impossible, and disjoint events; the inclusion-exclusion principle.

            \item Conditional probability: definition of conditional probability, partition of the sample space, and the partition theorem for probability.
            
            \item Independence: definition and properties of independent events.
        
        \end{itemize}
    \end{chapter}

    \begin{chapter}{Discrete random variables}

        \begin{itemize}
        
            \item Basic concepts: the definition of random variables, the probability mass function and cumulative distribution function of a discrete random variable.

            \item Discrete joint probability distributions; conditional probability; marginal distributions and independent random variables.
    ...
    \begin{chapter}{Continuous variables their distributions}

        \begin{itemize}
        
            \item Basic concepts: the definition of a continuous random variable, the probability density function and cumulative distribution function of a continuous random variable.

            \item Continuous joint probability distributions; conditional probability; marginal distributions and independent random variables.

            \item Normalization and transformation of distributions under an change of continuous variables.
    ...
    \begin{chapter}{Quantifying distributions}
        \begin{itemize}
            ...
            \item Expectation value and variance of continuous and discrete random variables.

            \item Expectation and variance of functions of continuous and discrete random variables.
    ...
    \begin{chapter}{The central limit theorem and other topics}
        \begin{itemize}
            ...
            \item The Monte-Carlo method, generators of pseudo-random numbers;
            the ``hit-and-miss'' method; generation of arbitrary distributions.
